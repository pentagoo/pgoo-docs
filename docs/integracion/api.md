...
> | nombre              |  tipo   | tipo de datos      | descripción                     |
> |-------------------|-----------|----------------|-------------------------------------|
> | `refId`           |  required | string         | Un identificador único para la orden. <code><br></code> Este campo es utilizado para correlacionar el pago con un pedido específico en su sistema.|
